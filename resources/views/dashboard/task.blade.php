                    ...
                    <div class="col-md-12">
                        <div class="card ">'
                            <div class="card-header card-header-rose card-header-text">
                                <div class="card-text">
                                    <h4 class="card-title">Criação de Tarefas</h4>
                                </div>
                            </div>
                            <div class="card-body ">
                                <form method="post" action="{{route("task")}}" class="form-horizontal">
                                    <div class="row">
                                        <label class="col-sm-2 col-form-label">Nome da Tarefa</label>
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Nome da Tarefa" name="NomeTarefa">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-sm-2 col-form-label">Descrição da Tarefa</label>
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <textarea  class="form-control" placeholder="Descrição da Tarefa" name="DescTarefa"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                                    <div class="form-group">
                                                        <input type="date" class="form-control" value="{{date('Y-m-d H:i:s')}}" name="dataentrega">
                                                    </div>
                                            </div>
                                        </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <select id="usuario2"  name="team" class="selectpicker" data-style="btn select-with-transition">
                                    ...
                                    <div class="row">
                                        <label class="col-sm-2 col-form-label">Selecione uma Prioridade</label>
                                        <div class="col-sm-10">
                                            <select id="usuario2"  name="prioridade" class="selectpicker" data-style="btn select-with-transition">
                                                <option value=null  selected disabled >Selecione uma Prioridade</option>
                                                    <tr>

                                                        <option value="1">1 - Prioridade Maxima</option>
                                                        <option value="2">2 - Prioridade Intermediária</option>
                                                        <option value="3">3 - Prioridade Média</option>
                                                        <option value="4">4 - Baixa Prioridade</option>
                                                        <option value="5">5 - Atividade Normal</option>
