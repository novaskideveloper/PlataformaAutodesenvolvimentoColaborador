                    ...
                    <div class="col-md-12">
                      ...
                      <b> Sucesso -  </b> {{$mensagemsucesso}}</span>
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                <form method="post" action="{{route("work")}}" class="form-horizontal">
                                    <div class="row">
                                        <label class="col-sm-2 col-form-label">Nome da Empresa</label>
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Nome da empresa" name="NomeEmpresa">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <input type="number" class="form-control" placeholder="CNPJ" name="CNPJ" minlength="14">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-sm-2 col-form-label">Endereço Completo</label>
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                    ...
                                    <div class="card-footer ">
                                        <button type="submit" class="btn btn-fill btn-rose" value="criar">Cadastrar Empresa</button>
                                    </div>
                                </form>
