                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header card-header-icon card-header-rose">
                                ...
                                <h4 class="card-title">Editar seu perfil
                                </h4>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{route("confirmprofile")}}">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Empresa</label>
                                                <input type="text" class="form-control" value="{{$workuser->Nome}}" disabled>
                                            </div>
                                        </div>
                                        {{--<div class="col-md-3">--}}
                                            {{--<div class="form-group">--}}
                                                {{--<label class="bmd-label-floating">Nome Completo</label>--}}
                                                {{--<input type="text" class="form-control" value="{{$user->Nome}}">--}}
                                            {{--</div>--}}
                                        {{--</div>--}}
                                        {{--<div class="col-md-4">--}}
                                            {{--<div class="form-group">--}}
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Tempo de Trabalho(Em meses)</label>
                                                <input type="number" class="form-control" value="{{$user->TempoTrabalho}}" name="TempoTrabalho">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Telefone Celular</label>
                                                <input type="number" class="form-control" value="{{$user->TelefoneCelular}}" name="TelCel">
                                            </div>
                                        </div>
                                    </div>
                                    {{ csrf_field() }}
