                                ...
                                <div class="col-md-12 mr-auto">
                                    ...
                                    <form class="form" method="post" action="{{route("registro")}}">
                                        ...
                                        <div class="col-md-4 mr-auto">
                                                <select id="empresa"  name="empresa" class="selectpicker" data-style="btn select-with-transition">
                                                    <option value=""  selected disabled>Selecione sua empresa</option>
                                                    @if(isset($empresa))
                                                @foreach($empresa as $emp)
                                                    <tr>

                                                        <option value="{{ $emp->IdEmpresa }}">{{ $emp->Nome }}</option>

                                                    </tr>
                                                @endforeach
                                                        @endif
                                                </select>
                                                {{--{!! Form::select('Nome', $selectDb, null, ['class'=>'dropdown-item']) !!}--}}
